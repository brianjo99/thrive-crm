...
import { LayoutDashboard, Users, FolderKanban, FileStack, Scissors, Camera, Crown, Sparkles, FolderOpen, ShieldCheck, Clapperboard, TrendingUp, Megaphone, CalendarDays, Receipt, FileText, ClipboardList, BookOpen, Settings, BarChart3, Film, FileCheck, Globe } from "lucide-react";
  ...
  owner: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Sitios Web",   url: "/sites",     icon: Globe,        module: "leads" },
      ],
    },
    {
      label: "Sistema",
